...
## [0.2.0] - 2026-02-13
### Added
- Release checklist and CI quality gates.
- Performance budget tests and golden layout snapshot tests.
- Smart device selection for run flow (module+variant aware).

### Changed
- Packaging and README quality updates for release prep.

## [0.1.7] - 2026-02-13
### Added
- Initial stable feature set for Android Tools in VS Code:
  - Run/Install/Stop workflows
  - Emulator and device controls
  - Logcat and project tooling
  - XML layout helpers and preview flows
