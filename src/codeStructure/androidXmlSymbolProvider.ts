/**
 * Android XML Document Symbol Provider
 * Provides outline structure for Android XML files (layouts, resources, manifests)
 */

import * as vscode from 'vscode';

/**
 * XML element parsed from document
 */
...
/**
 * DocumentSymbolProvider for Android XML files
 * Provides structure for:
 * - Layout files (view hierarchy)
...
export class AndroidXmlSymbolProvider implements vscode.DocumentSymbolProvider {
  /**
   * Provide document symbols for Android XML files
   */
  provideDocumentSymbols(
    ...
    // Determine XML type and parse accordingly
  ...
  /**
   * Parse Android layout file
   * Creates hierarchy based on view nesting
   */
  private parseLayout(
    document: vscode.TextDocument,
    text: string
  ...
  private parseManifest(
    ...
    for (const componentType of componentTypes) {
      ...
      while ((match = regex.exec(text)) !== null) {
        ...
        // Simplify name (remove package prefix if present)
  ...
  /**
   * Get symbol kind for resource type
   */
  ...
  /**
   * Get symbol kind for manifest component
   */
